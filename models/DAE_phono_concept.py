...
code = Dense(latent_dim,activation="tanh")(h_concat)
...
phono_decoding_intermediate = phono_decoding_layer_intermediate(code)

phono_decoding_layer_decoded = Dense(original_dim_phono,activation="relu",name="phono_decoding_layer_decoded")
...
concept_decoding_intermediate = concept_decoding_layer_intermediate(code)

concept_decoding_layer_decoded = Dense(original_dim_concept,activation="relu",name="concept_decoding_layer_decoded")
...
for lang in languages:
    ...
    c_lang += 1
print("pickling ...")
pickle.dump(languages,open("languages_DAE_phono_concept.pkl","wb"))
